...
<div class="card">
    ...
    <div class="card-body px-lg-5 pt-0">
        ...
        <!-- Form -->
        <form class="text-center" style="color: #757575;"action="index.php?c=employee&m=UpdateEmployee" method="post">
            ...
            <div class="form-row">
                <div class="col">
                    ...
                    <!-- First name -->
                    <div class="md-form">
                        <input READONLY type="text" id="materialRegisterFormFirstName" class="form-control" name="EmployeeId" value="<?= $param->EmployeeID?>" >
